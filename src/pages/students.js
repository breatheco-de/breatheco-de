  ...
  return (
    <div class="container">
        ...
        <div className="row">
            ...
            <div className="col-8">
                <small>
                Check if your commit is showing alreading on the main repository <a target="_blank" href="https://github.com/4GeeksAcademy/student-external-profile/commits/master">commits history</a> and your pull request should be listed as "closed" on the <a target="_blank" href="https://github.com/4GeeksAcademy/student-external-profile/pulls?utf8=%E2%9C%93&q=is%3Apr+is%3Aclosed+is%3Aopen"> repository list of pull requests</a>
                </small>
            </div>
        </div>
