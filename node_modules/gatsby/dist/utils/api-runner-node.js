...
const {
  default: errorParser
} = require(`./api-runner-error-parser`); // Bind action creators per plugin so we can auto-add
...
const getLocalReporter = (activity, reporter) => activity ? Object.assign({}, reporter, {
