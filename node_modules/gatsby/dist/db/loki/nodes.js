...
const FIELD_INDEX_THRESHOLD = 5; // Every time we run a query, we increment a counter for each of its
...
function ensureFieldIndexes(typeName, lokiArgs, sortArgs) {
  ...
  _.forEach(lokiArgs, (v, fieldName) => {
    ...
    _.update(fieldUsages[typeName], fieldName, n => n ? n + 1 : 1); // If we have crossed the threshold, then create the index
