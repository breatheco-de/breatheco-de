...
const preValidationRules = [LoneAnonymousOperationRule, KnownTypeNamesRule, FragmentsOnCompositeTypesRule, VariablesAreInputTypesRule, ScalarLeafsRule, PossibleFragmentSpreadsRule, ValuesOfCorrectTypeRule, VariablesInAllowedPositionRule];
  ...
  const transformer = visitWithTypeInfo(typeInfo, {
    ...
    leave: {
      [Kind.SELECTION_SET]: node => {
        ...
        return extraFields.length > 0 ? Object.assign({}, node, {
