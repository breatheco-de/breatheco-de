import { StateMachine, Event, EventObject, DefaultContext, StateSchema, OmniEventObject, OmniEvent, Sender } from './types';
...
export declare class Interpreter<TContext, TStateSchema extends StateSchema = any, TEvent extends EventObject = EventObject> {
     ...
     */
    init: (initialState?: State<TContext, TEvent>) => Interpreter<TContext, TStateSchema, TEvent>;
    /**
     * Starts the interpreter from the given state, or the initial state.
     * @param initialState The state to start the statechart from
     */
    start(initialState?: State<TContext, TEvent>): Interpreter<TContext, TStateSchema, TEvent>;
    /**
