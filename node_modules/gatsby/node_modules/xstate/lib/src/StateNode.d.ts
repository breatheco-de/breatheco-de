...
declare class StateNode<TContext = DefaultContext, TStateSchema extends StateSchema = any, TEvent extends OmniEventObject<EventObject> = OmniEventObject<EventObject>> {
    ...
    private __cache;
    private idMap;
    constructor(_config: StateNodeConfig<TContext, TStateSchema, TEvent>, options?: MachineOptions<TContext, TEvent>, 
    /**
     * The initial extended state
     */
    context?: Readonly<TContext> | undefined);
     ...
     */
    withConfig(options: MachineOptions<TContext, TEvent>, context?: TContext | undefined): StateNode<TContext, TStateSchema, TEvent>;
    /**
