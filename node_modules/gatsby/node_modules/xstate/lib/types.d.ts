...
export interface ExecMeta<TContext, TEvent extends EventObject> extends StateMeta<TContext, TEvent> {
 ...
 */
export declare type InvokeCreator<TFinalContext, TContext> = (context: TContext, event: EventObject) => PromiseLike<TFinalContext> | StateMachine<TFinalContext, any, any> | InvokeCallback;
