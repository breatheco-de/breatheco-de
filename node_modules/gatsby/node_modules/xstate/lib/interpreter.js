...
var Interpreter = /** @class */ (function () {
    ...
    Interpreter.prototype.start = function (initialState) {
        ...
        var resolvedState = initialState === undefined
            ...
            : initialState instanceof State_1.State
                ...
                : this.machine.resolveState(State_1.State.from(initialState));
    ...
    Interpreter.prototype.defer = function (sendAction) {
        ...
        if (utils_1.isString(delay)) {
            if (!this.machine.options.delays ||
                ...
                // tslint:disable-next-line:no-console
                utils_1.warn(false, "No delay reference for delay expression '" + delay + "' was found on machine '" + this.machine.id + "' on service '" + this.id + "'.");
    ...
    Interpreter.prototype.stopChild = function (childId) {
        ...
        if (child && utils_1.isFunction(child.stop)) {
            child.stop();
    ...
    Interpreter.prototype.spawnPromise = function (id, promise) {
        ...
        promise
            ...
            if (!canceled) {
                var errorEvent = actions_1.error(errorData, id);
                try {
    ...
    Interpreter.prototype.spawnCallback = function (id, callback) {
        ...
        var listener = function (e) {
            utils_1.warn(false, "Event '" + e.type + "' sent to callback service '" + id + "' but was not handled by a listener.");
        };
        var stop;
        try {
            ...
            if (utils_1.isPromiseLike(stop)) {
                Promise.resolve(stop).catch(function (e) {
                    var errorEvent = actions_1.error(e, id);
                    try {
                        _this.send(errorEvent);
                    }
                    catch (error) {
