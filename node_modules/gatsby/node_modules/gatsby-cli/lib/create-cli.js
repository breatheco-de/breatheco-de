...
const _require = require(`gatsby-telemetry`),
      ...
      setDefaultTags = _require.setDefaultTags,
...
function buildLocalCommands(cli, isLocalSite) {
  ...
  function installedGatsbyVersion() {
    ...
    try {
      ...
      try {
        setDefaultTags({
          installedGatsbyVersion: packageInfo.version
        });
      } catch (e) {// ignore
      }
...
function isLocalGatsbySite() {
  ...
  try {
    let _require2 = require(path.resolve(`./package.json`)),
        dependencies = _require2.dependencies,
        devDependencies = _require2.devDependencies;
