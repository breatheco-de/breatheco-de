...
describe('InterfaceTypeComposer', () => {
  ...
  describe('fields manipulation', () => {
    ...
    describe('field arguments', () => {
      ...
      it('getFieldArgs()', () => {
        ...
        expect(args.arg1.type).toBe(_graphql.GraphQLInt);
  ...
  describe('get()', () => {
    it('should return type by path', () => {
      ...
      expect(myIFTC.get('field1')).toBe(_graphql.GraphQLString);
      expect(myIFTC.get('field1.@arg1')).toBe(_graphql.GraphQLInt);
    });
  });
  ...
  describe('getFieldTC()', () => {
    const myIFTC = _.schemaComposer.createInterfaceTC('MyCustomType');
