...
class InterfaceTypeComposer {
  ...
  static createTemp(typeDef, schemaComposer) {
    ...
    if ((0, _is.isString)(typeDef)) {
      ...
      const type = new _graphql.GraphQLInterfaceType(_objectSpread({}, typeDef, {
        fields: (0, _is.isFunction)(fields) ? () => (0, _configAsThunk.resolveOutputConfigMapAsThunk)(sc, fields(), typeDef.name) : () => ({})
      }));
      IFTC = new InterfaceTypeComposer(type, sc);
      if ((0, _is.isObject)(typeDef.fields)) IFTC.addFields(typeDef.fields);
  ...
  getFieldTC(fieldName) {
    ...
    return _ObjectTypeComposer.ObjectTypeComposer.createTemp(fieldType, this.schemaComposer);
  }
  ...
  clone(newTypeName) {
    ...
    const cloned = new InterfaceTypeComposer(new _graphql.GraphQLInterfaceType({
      name: newTypeName,
      fields: newFields
    }), this.schemaComposer);
  ...
  getFieldExtensions(fieldName) {
    ...
    if ((0, _is.isObject)(field) && !(0, _is.isFunction)(field) && !Array.isArray(field) && !(0, _ObjectTypeComposer.isComposeOutputType)(field)) {
