import { GraphQLInputObjectType, GraphQLString, GraphQLList, GraphQLNonNull, GraphQLInt, GraphQLBoolean } from '../graphql';
...
describe('InputTypeComposer', () => {
  ...
  describe('field manipulation methods', () => {
    ...
    describe('setFields()', () => {
      ...
      it('accept types as function', () => {
        ...
        expect(itc.getFieldType('input3')).toBe(GraphQLString); // show provide unwrapped/unhoisted type for graphql

        if (graphqlVersion >= 14) {
          expect(itc.getType()._fields().input3.type).toBe(GraphQLString);
        } else {
    ...
    it('addNestedFields()', () => {
      ...
      expect(itc.getFieldType('fieldNested2').ofType).toBe(GraphQLInt);
    });
    it('removeField()', () => {
    ...
    it('makeFieldNonNull()', () => {
      ...
      expect(itc.getFieldType('input1').ofType).toBe(GraphQLString);
      expect(itc.isFieldNonNull('input1')).toBe(true);
      expect(itc.isRequired('input1')).toBe(true);
    });
    it('makeRequired()', () => {
    ...
    it('should add fields with converting types from string to object', () => {
      ...
      expect(itc.getFieldType('input4').ofType).toBe(GraphQLInt);
      expect(itc.getFieldType('input5')).toBeInstanceOf(GraphQLNonNull);
      expect(itc.getFieldType('input5').ofType).toBe(GraphQLBoolean);
    });
  });
  ...
  it('get() should return type by path', () => {
    const itc1 = new InputTypeComposer(new GraphQLInputObjectType({
      name: 'Writable',
      fields: {
        field1: {
          type: GraphQLString
