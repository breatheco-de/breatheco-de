import { GraphQLString, GraphQLFloat, GraphQLInt, GraphQLBoolean, GraphQLID, GraphQLObjectType, GraphQLInputObjectType, GraphQLList, GraphQLNonNull, GraphQLEnumType, GraphQLScalarType, GraphQLInterfaceType, GraphQLUnionType } from '../graphql';
...
describe('TypeMapper', () => {
  ...
  it('should create object type from template string', () => {
    const type = typeMapper.createType(graphqlVersion < 12 ? `
          type IntRange {
            # Max value
            max: Int,
            min: Int!
  ...
  it('should return wrapped type', () => {
    ...
    expect(typeMapper.getWrapped('[String]!')).toBeInstanceOf(GraphQLNonNull);
    expect(typeMapper.getWrapped('[String]!').ofType).toBeInstanceOf(GraphQLList);
  ...
  describe('convertOutputFieldConfig()', () => {
    describe('converting field type', () => {
      ...
      it('should create field config from GraphQL Schema Language', () => {
        ...
        const tc = new ObjectTypeComposer(fc.type, sc);
  ...
  describe('createType()', () => {
    it('should return same type for the same TypeDefinitionString', () => {
      ...
      expect(t1).toBe(t2);
      const tc = ObjectTypeComposer.create(t1, sc);
