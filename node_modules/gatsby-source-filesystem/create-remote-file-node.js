...
const bar = new ProgressBar(`Downloading remote files [:bar] :current/:total :elapsed secs :percent`, {
  total: 0,
  width: 30
});
/********************
...
function _processRemoteNode() {
  _processRemoteNode = (0, _asyncToGenerator2.default)(function* ({
    ...
    const response = yield requestRemoteNode(url, headers, tmpFilename, httpOpts);
