...
const argsWhitelist = [`height`, `width`, `cropFocus`, `toFormat`, `pngCompressionLevel`, `quality`, `jpegProgressive`, `grayscale`, `rotate`, `duotone`, `fit`, `background`];
/**
...
exports.processFile = (file, transforms, options = {}) => {
  ...
  function () {
    var _ref = (0, _asyncToGenerator2.default)(function* (transform) {
      ...
      let clonedPipeline = transforms.length > 1 ? pipeline.clone() : pipeline; // Sharp only allows ints as height/width. Since both aren't always
